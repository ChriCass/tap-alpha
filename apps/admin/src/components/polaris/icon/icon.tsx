...
const paths: Record<string, ReactNode> = {
  ...
  hide: (
    <>
      <path d="M4 4l16 16" />
      <path d="M10.6 5.64A10.7 10.7 0 0 1 12 5.5c6 0 9.5 6.5 9.5 6.5a13.5 13.5 0 0 1-3.13 3.9M6.6 7.1C4.13 8.8 2.5 12 2.5 12s3.5 6.5 9.5 6.5a9.7 9.7 0 0 0 3.9-.8" />
      <path d="M9.9 9.9a2.8 2.8 0 0 0 3.95 3.95" />
    </>
  ),
  home: (
    <>
