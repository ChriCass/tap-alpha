  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-12">
      ...
      <div className="mt-8 grid grid-cols-1 gap-12 lg:grid-cols-[1.1fr_1fr]">
        <div className="overflow-hidden rounded-[var(--theme-radius)] border border-white/10 bg-neutral-900">
        ...
        <div>
          ...
          <div className="mt-8 flex items-baseline gap-4">
            <span
              className="rounded-[var(--theme-radius)] px-4 py-2 text-2xl font-black text-neutral-950"
            ...
            <div className="mt-10">
              ...
              <div className="flex flex-wrap gap-3">
                {product.variants.map((variant) => (
                  <div
                    key={variant.id}
                    className={`rounded-[var(--theme-radius)] border px-4 py-3 ${
                      variant.in_stock
